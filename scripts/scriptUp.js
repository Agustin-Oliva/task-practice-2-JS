...
// Funciones para imprimir las cards
      ...
      function insertUpCards(array){
   bodyDos = ``;
  let containUpcomingUpdate = document.getElementById("up_events");
      for(let i=0; i < array.length; i++){
          bodyDos += `
        <div class="col col-card">
          <div class="card" style="width: 18rem;">
            <img src="${array[i].image}" class="card-img-top" alt="books">
            <div class="card-body">
  ...
  for(let i=1; i < array.length; i++){
        ...
        carouselUpUpdate.innerHTML = carousel;
        };
