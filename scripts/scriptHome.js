...
insertCarouselHomeCards(events);
...
//Funcion que devuelve un array de las categorias filtradas
  ...
  function filterCategory(array){
    /* let newArray =  array.filter(element => element.category == category);
    insertHomeCards(newArray);
    insertCarouselHomeCards(newArray); */
